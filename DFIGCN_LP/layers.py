from DFIGCN_LP.initializations import *
...
class BGraphConvolution(Layer):
    def __init__(self,input_dim, output_dim, adj, features_nonzero, dropout=0.,
                 sparse_inputs=True, act=tf.nn.relu, bias=True, **kwargs):
        ...
        self.num_features_nonzero = features_nonzero
    ...
    def _call(self, inputs):
        ...
        pre_sup_al = pre_sup_a + pre_sup_b + pre_sup_sec_ord

        emb = tf.stack([pre_sup_c, pre_sup_al], axis=1)
        pre_sup, a = self.attention(emb)
